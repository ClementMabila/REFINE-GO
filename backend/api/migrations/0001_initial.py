...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PetrolStation',
            fields=[
                ('google_place_id', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100)),
                ...
                ('busy_level', models.CharField(default='low', max_length=20)),
                ('wait_time', models.PositiveIntegerField(default=0)),
                ('price_update_frequency', models.CharField(choices=[('high', 'High (Multiple times per day)'), ('medium', 'Medium (Daily)'), ('low', 'Low (Weekly or less)')], default='low', max_length=20)),
                ('last_price_update', models.DateTimeField(blank=True, null=True)),
                ('data_quality_score', models.FloatField(default=0.5)),
                ('is_verified', models.BooleanField(default=False)),
                ('verification_source', models.CharField(blank=True, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('source', models.CharField(choices=[('user_report', 'User Report'), ('google_places', 'Google Places'), ('gasbuddy', 'GasBuddy'), ('aaa', 'AAA'), ('eia', 'Energy Information Administration'), ('api_scrape', 'API/Web Scraping')], default='user_report', max_length=50)),
                ('confidence_score', models.FloatField(default=0.5)),
                ('is_verified', models.BooleanField(default=False)),
                ('verification_method', models.CharField(blank=True, max_length=50)),
                ('previous_price', models.DecimalField(blank=True, decimal_places=3, max_digits=6, null=True)),
                ('price_change', models.DecimalField(blank=True, decimal_places=3, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('planned_distance', models.DecimalField(decimal_places=2, help_text='Planned distance in km', max_digits=8)),
                ('actual_distance', models.DecimalField(blank=True, decimal_places=2, help_text='Actual distance in km', max_digits=8, null=True)),
                ...
                ('cancellation_reason', models.CharField(blank=True, choices=[('user_cancelled', 'User Cancelled'), ('route_changed', 'Route Changed'), ('destination_changed', 'Destination Changed'), ('technical_issue', 'Technical Issue'), ('other', 'Other')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_type', models.CharField(choices=[('earned', 'Points Earned'), ('redeemed', 'Points Redeemed'), ('expired', 'Points Expired'), ('bonus', 'Bonus Points'), ('refund', 'Refund')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_purchased', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True)),
                ...
                ('petrol_station', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.petrolstation')),
                ('trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='waypoints', to='api.trip')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.AddField(
            model_name='trip',
            name='vehicle',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trips', to='api.vehicle'),
        ),
        migrations.CreateModel(
