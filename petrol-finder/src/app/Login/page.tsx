  ...
  const onVerifyOtp = async (data: OtpData) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        window.location.href = '/Dashboard'; // or handle routing as needed
      } else {
      ...
      <div className="max-w-md mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className={`text-base ${isDark ? 'text-gray-400' : 'text-gray-600'} leading-relaxed`}>
            {step === "form" ? (
              <>
                Sign in to <span className="bg-[#2edda2] bg-clip-text text-transparent">your RefineGo account</span> to continue
              </>
            ) : (
              <>
                We sent a <span className="bg-[#2edda2] bg-clip-text text-transparent">verification code</span> to {email}
              </>
            )}
          </p>
        </div>
            ...
            {step === "form" ? (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    <input
                      ...
                      type="email"
                      placeholder="Email"
                      className={`w-full px-4 py-3 rounded-xl border transition-all focus:outline-none focus:ring-2 focus:ring-[#25c993] ${
                        isDark 
                ...
                <div className="text-right">
                  <a href="/ForgotPassword" className="text-sm text-[#2edda2] hover:text-[#25c993] font-medium">
                    Forgot password?
                  </a>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-[#2edda2] hover:bg-[#25c993] text-white font-medium py-3 px-4 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-[#25c993] focus:ring-offset-2"
                >
                  Sign in
                </button>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <button
                    onClick={handleOtpSubmit(onVerifyOtp)}
                    className="w-full bg-[#2edda2] hover:bg-[#25c993] text-white font-medium py-3 px-4 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-[#25c993] focus:ring-offset-2"
                  >
                    Verify and sign in
                  </button>
                ...
                <div className="text-center">
                  <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    ...
                    <button onClick={handleResendOtp} className="text-[#2edda2] hover:text-[#25c993] font-medium">
                      Resend
                    </button>
                  </p>
                </div>
        ...
        <div className="text-center mt-8">
          <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <a href="/register" className="text-[#2edda2] hover:text-[#25c993] font-medium">
              Create account
            </a>
          </p>
        </div>
